...
st.sidebar.markdown('This is an app that retreives financial data from a goole sheet, displays it in a chart, and allows users to comment on it storing it in the cloud; created by <a href="https://ai.jdavis.xyz" target="_blank">0xjdavis</a>.', unsafe_allow_html=True)
